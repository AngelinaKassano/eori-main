<template>
  <div class="banner-1">
    ...
    <div class="flex items-center">
      <div class="w-11/12 space-y-5 md:space-y-10">
        <h1
          class="3xl:text-6xl 2xl:text-7xl xl:text-6xl lg:text-4xl md:text-3xl sm:text-3xl text-xl font-Moscow2024 font-bold leading-tight text-gray-700"
        >
        Аниме ночники:
          <a>
      ...
      <div class="w-8/12 flex justify-end">
        <img
          class="3xl:h-[700px] 2xl:h-[550px] xl:h-[550px] lg:h-[550px] md:h-[450px] sm:h-[350px]"
  ...
  <div class="banner-2 space-y-10 pb-20" id="work">
    ...
    <div class="card">
      <div class="space-y-5 py-8 px-8 md:py-16 md:px-20 md:w-1/2">
        <h4 class="project-title item">Новость 1</h4>
        ...
        <a href="/catalog" class="text-sky-800 font-bold text-2xl tracking-wider">
  Перейти
</a>
      </div>
    ...
    <div class="card">
      <div class="space-y-5 py-8 px-8 md:py-16 md:px-20 md:w-1/2">
        <h4 class="project-title item">Новость 2</h4>
        <p class="font-work_sans pr-12">
          Designed some empty state screens in kawaii style for the popular
          sheepify app.Tailwind lets you conditionally apply utility classes in
          different states using variant modifiers. For example, use hover:gap-6
    ...
    <div class="card">
      <div class="space-y-5 py-8 px-8 md:py-16 md:px-20 md:w-1/2">
        <h4 class="project-title item">Новость 3</h4>
        <p class="font-work_sans pr-12">
          Designed some empty state screens in kawaii style for the popular
          sheepify app.Tailwind lets you conditionally apply utility classes in
          different states using variant modifiers. For example, use hover:gap-6
  ...
  <div class="banner-1 flex h-full items-center">
    <div class="w-7/12 p-12">
      ...
      <a class="underline text-2xl text-black-400 font-work_sans" 
        >📧 hire@author.com</a  
